    ...
    return (
        <div>
            ...
            <div className='flex lg:flex-row flex-col py-2 justify-center items-center'>
                ...
                <span className='font-extrabold subpixel-antialiased text-center text-2xl'>(Late) Bro. R. Asokan</span>
            ...
            <div className='flex lg:flex-row-reverse flex-col py-2 justify-center items-center'>
                ...
                <span className='font-extrabold subpixel-antialiased text-center text-2xl'>Dr. T. Patricia Rathi Priya</span>
