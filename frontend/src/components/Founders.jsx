...
const Founders = () => {
    ...
    return (
        <div>
            <p className='font-bold text-3xl text-center pt-5 lg:pt-20 underline'>Our Founders</p>
            <div className='flex lg:flex-row flex-col py-2 justify-center items-center'>
                ...
                <span className='font-extrabold subpixel-antialiased text-center text-2xl'>(Late) Bro. R. Ashokan</span>
            ...
            <div className='flex lg:flex-row-reverse flex-col py-2 justify-center items-center'>
                ...
                <span className='font-extrabold subpixel-antialiased text-center text-2xl'>Dr. T. Petricia Rathi Priya Ashokan</span>
