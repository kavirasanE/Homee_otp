      ...
      <div className="bg-white  z-10 mx-2 lg:mx-48 my-10  rounded-xl">
        ...
        <form class="max-w-sm  mx-auto pb-5 px-2">
          ...
          <div class="flex items-center py-2">
            ...
            <label
              for="link-checkbox"
              class="ms-2 text-md font-bold text-gray-900 dark:text-gray-300"
            >
              Would you like to subscribe our Magazine ?
          ...
          {/* <div class="flex items-start mb-5">
                ...
                By submitting this form,You may opt out from communication at any time here or through the opt out option placed in the e-mail communication sent by us.
                </p>
          <button
            type="submit"
