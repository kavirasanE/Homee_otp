...
const Footer = () => {
    return (
        <div className='bg-black text-white/70 flex flex-row justify-between px-5 items-center py-5'>
            <div className='flex flex-col justify-center'>
                ...
                <div className='flex flex-col py-5 justify-start items-start gap-2'>
