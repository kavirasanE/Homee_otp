...
//         <img className="w-48 h-48" src={currentPage === 2 ? logo1: magazine } alt={`Page ${currentPage}`} />
//       </div>
//       <div className="absolute w-full h-full bg-yellow-500 back flex justify-center items-center rotate-y-360">
//         <img className="w-48 h-48" src={currentPage === 3 ? magazine : logo1} alt={`Page ${currentPage}`} />
//       </div>
//     </div>
